    ...
    public class clsUpload
    {
            ...
            try
            {
                ...
                if (provider.FileData.Count > 0)
                {
                    ...
                    if (!Existe)
                    {
                        ...
                        return request.CreateResponse(HttpStatusCode.OK, "Se cargaron los archivos en el servidor, " + RptaBD);
                    }
                    else
                    {
                        return request.CreateErrorResponse(HttpStatusCode.Conflict, "Ya existen los archivos en el servidor");
                    }
                }
                else
                {
        ...
        public HttpResponseMessage LeerArchivo(string archivo)
        {
            ...
            try
            {
                ...
                {
                    return request.CreateErrorResponse(HttpStatusCode.InternalServerError, "El archivo no se encuentra en el servidor");
                }
            }
            catch (Exception ex)
            {
                return request.CreateErrorResponse(HttpStatusCode.InternalServerError, "No se pudo procesar el archivo. " + ex.Message);
            }
        }
